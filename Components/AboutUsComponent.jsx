...
export default function AboutUsComponent() {
    return (
        <div className='AboutUsContainer'>
            <div className="Content" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', fontSize: 18, marginBottom: 30 }}>
                <div className="Heading">
                    <h1>About Us</h1>
                </div>
                <p style={{ marginBottom: 10, maxWidth: 1000, width: '90%', marginTop: 30 }}>
                ...
                <p style={{ marginBottom: 10, maxWidth: 1000, width: '90%' }}>
                ...
                <p style={{ maxWidth: 1000, width: '90%' }}>
